...
<html>
	...
	<body>
		<form method="post" action="sendSelfSettleConfirm.php" accept-charset="UTF-8">
			<table width="80%" border="0" align="center" cellpadding="10" cellspacing="0" style="border:solid 1px #107929">
               ...
               <td width="5%"  align="center"> - </td> 
					...
					<tr >
					<td width="20%" align="left">&nbsp;操作人</td>
					<td width="5%"  align="center"> : &nbsp;</td> 
					<td width="55%" align="left"> 
						<input size="70" type="text" name="operator" value=""/>
						<span style="color:#FF0000;font-weight:100;">*</span>
					</td>
					<td width="5%"  align="center"> - </td> 
					<td width="15%" align="left">operator</td> 
				</tr>
