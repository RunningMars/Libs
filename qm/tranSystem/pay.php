...
<head>
	...
	<tr >
				...
				<tr >
					...
					<td width="5%"  align="center"> : &nbsp;</td> 
					<td width="55%" align="left"> 
						<input size="70" type="text" name="merchantExpireTime"    value="10"  />
					</td>
					<td width="5%"  align="center"> - </td> 
            ...
            <td width="55%" align="left">
               ...
               <input type="radio" name="payTool" id="BALANCE" value="BALANCE"
                ...
                <input type="radio" name="payTool" id="WECHATSDK" value="WECHATSDK"
                  ...
                  <input type="radio" name="payTool" id="WECHATMINIPRO" value="WECHATMINIPRO"     
			   onclick= "closeSale();closeWechatApp();closeBind();closeWechatmicro();closeWechatOffical();"/><label for="WECHATMINIPRO" >微信小程序API版</label>
