	...
	<div id="ACCOUNT_PAY_SEL" class="close">
        ...
        <span style="background: #6BBE18;">付款到银行</span>
			<table>
                ...
                <tr>
                    <td>普通（固定底价）</td>
                    <td><input type="text" name="payToBankNormalFee">元/笔</td>
                </tr>
				  <tr>
                    <td>普通（百分比）</td>
                    <td><input type="text" name="payToBankNormalPercentFee">%</td>
                </tr>
				  <tr>
                    <td>实时（固定底价）</td>
                    <td><input type="text" name="payToBankActualFee">元/笔</td>
                </tr>
					  <tr>
                    <td>实时（百分比）</td>
                    <td><input type="text" name="payToBankActualPercentFee">%</td>
                </tr>
				  <tr>
                    <td> 7*24小时（固定底价）</td>
                    <td><input type="text" name="payToBank7DayFee">元/笔</td>
                </tr>
				<tr>
                    <td> 7*24小时（百分比）</td>
                    <td><input type="text" name="payToBank7DayPercentFee">%</td>
                </tr>
				<tr >
