...
<table width="400" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
    ...
    <tr id="LM4" style="DISPLAY: none" >
	  ...
	  <tr>
        <td> + <a onclick="javascript:ShowFLT(5)" href="javascript:void(null)">商户结算 </a></td>
    </tr>
    <tr id="LM5" style="DISPLAY: none" >
        <td><table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                    <td style="padding-left:20px;" > --<a  href="./settlement/querySelfSettleInfo.php" >查询自助结算信息</a></td>
                </tr>
				
				  <tr>
                    <td style="padding-left:20px;" > --<a  href="./settlement/calculateSelfSettle.php" >查询可结算金额</a></td>
                </tr>
				
				  <tr>
                    <td style="padding-left:20px;" > --<a  href="./settlement/selfSettleConfirm.php" >确认结算</a></td>
                </tr>
				 <tr>
                    <td style="padding-left:20px;" > --<a  href="./settlement/querySettleRecode.php" >查询结算记录</a></td>
                </tr>
	 
            </table></td>
    </tr>
	    <tr>
        <td> + <a onclick="javascript:ShowFLT(6)" href="javascript:void(null)">基础数据 </a></td>
    </tr>
    <tr id="LM6" style="DISPLAY: none" >
	    ...
	    <tr>
        <td> + <a onclick="javascript:ShowFLT(7)" href="javascript:void(null)">生成商户入网JSON信息 </a></td>
    </tr>
