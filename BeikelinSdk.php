...
class BeikelinSdk
{
	...
	const open_url  = 'http://test.beikelin.com/';//外网测试地址
    const appId     = '68ccdfadf66affab10ecdfc90abf8c62';//商户id
    const appKey    = '7d546ddd9223cfasf5df0e124266b092';//数据签名key
    const encryptKey= '6fa5616gg3ac92228a9dd9a0be5cac9f';//数据加密key
